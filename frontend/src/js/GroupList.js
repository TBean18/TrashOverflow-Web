...
function GroupList() {
    ...
    const exampleImg = 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallsdesk.com%2Fwp-content%2Fuploads%2F2016%2F03%2FGiraffe-Wallpaper-for-Computer.jpg&f=1&nofb=1'

    function displayGroups(groups){
        if(!Array.isArray(groups)) return
        return groups.map(group => (<GroupCard curGroup={group} img={exampleImg}/>))
    }
